...
%	\input{chapters/interpretability_background.tex}
...
%%				\input{chapters/interpretability/relaxed-cnf/abstract.tex}
%				\input{chapters/interpretability/relaxed-cnf/introduction.tex}
%%				\input{chapters/interpretability/relaxed-cnf/related_work.tex}
%%				\input{chapters/interpretability/relaxed-cnf/preliminaries.tex}
...
%
%In this part of the thesis, we discuss fairness verification for classifiers represented as Boolean formulas in Chapter~\ref{chapter:justicia} and linear classifiers in Chapter~\ref{chapter:fvgm}. Finally, we discuss identification of sources of unfairness in Chapter~\ref{chapter:fif}.
%%	
%%%	Fairness
%%	\input{chapters/fairness_background.tex}	
%
%%%		Justicia
%			\chapter{A Stochastic SAT Approach to Formally Verify Fairness}
%%				\input{chapters/fairness/justicia/abstract.tex}
%				\input{chapters/fairness/justicia/introduction.tex}
%%				\input{chapters/fairness/justicia/preliminaries.tex}
...
%%				\input{chapters/fairness/fvgm/abstract}
%				\input{chapters/fairness/fvgm/introduction}
%%				\input{chapters/fairness/fvgm/background}
...
%%				\input{chapters/fairness/fif/abstract.tex}
%				\input{chapters/fairness/fif/introduction.tex}
%%				\input{chapters/fairness/fif/preliminaries.tex}
