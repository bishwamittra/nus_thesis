...
In this part of the thesis, we discuss fairness verification for finite classifiers that are encoded as Boolean formulas in Chapter~\ref{chapter:justicia} and a special case of linear classifiers in Chapter~\ref{chapter:fvgm}. We conclude by discussing the explanation of group fairness metrics in Chapter~\ref{chapter:fif}.
