...
In this part of the thesis, we discuss fairness verification for finite classifiers encoded as Boolean formulas in Chapter~\ref{chapter:justicia} and a special case of linear classifiers in Chapter~\ref{chapter:fvgm}.
