...
\begin{figure}[t!]
	\begin{center}
		...
		\subfloat[COMPAS]{\includegraphics[scale=0.24]{figures/dependency_exp_Learn-dependency_compas_lr_sex_0}\label{fig:fif_a}}
		\subfloat[COMPAS]{\includegraphics[scale=0.24]{figures/dependency_exp_Learn-dependency_compas_lr_sex_1}\label{fig:fif_b}}\\
		\subfloat[Adult]{\includegraphics[scale=0.24]{figures/dependency_exp_Learn-dependency_adult_lr_sex_0}\label{fig:fif_d}}
		\subfloat[Adult]{\includegraphics[scale=0.24]{figures/dependency_exp_Learn-dependency_adult_lr_sex_1}\label{fig:fif_e}}\\
		\subfloat[COMPAS]{\includegraphics[scale=0.24]{figures/dependency_exp_Learn-dependency_compas_lr_sex_DI}\label{fig:fif_c}}
		\subfloat[Adult]{\includegraphics[scale=0.24]{figures/dependency_exp_Learn-dependency_adult_lr_sex_DI}\label{fig:fif_f}}\\
		
	
		
	\end{center}
	\caption{Extended results on computing feature influence functions (FIF) for COMPAS  and Adult dataset.}\label{fig:fif}
\end{figure}
