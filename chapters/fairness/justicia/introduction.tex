...
\begin{figure}[!t]
	...
	\subfloat[Dependency among features and prediction]{\scalebox{1}{	
			...
			\edge[] {h,i} {p} ;
			\end{tikzpicture}
	}\label{fairness_justicia_fig:fair_example_dependency}}\hfill
	...
	\subfloat[Trained decision tree]{
		\scalebox{0.55}{	
			...
			\end{tikzpicture}}
	\label{fairness_justicia_fig:fair_example_dt}}\hfill
...
\paragraph{Fairness Verifiers.} Due to the abundance of fairness metrics and difference in algorithms to achieve them, it has become necessary to verify different fairness metrics over datasets and algorithms. 
