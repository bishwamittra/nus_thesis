...
\begin{figure}[t!]%%\vspace*{-1em}
	...
	\begin{minipage}{.35\columnwidth}
		\scalebox{0.48}{	
			...
			\end{tikzpicture}}
	\end{minipage}%
	\caption{A trained decision tree to learn eligibility for health insurance using age-dependent fitness and income indicators.}\label{fairness_justicia_fig:fair_example}%\vspace*{-2em}
\end{figure}
