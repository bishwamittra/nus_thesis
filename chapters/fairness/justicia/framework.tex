...
\subsection{\red{Inference Approach with ER-SSAT Encoding}}
...
Hence, we propose efficient SSAT encodings to \textit{learn} the most favored group and the least favored group for given  $\alg$ and $ \mathcal{D} $, and to compute their \red{probability of positive prediction}s to measure different fairness metrics. 
