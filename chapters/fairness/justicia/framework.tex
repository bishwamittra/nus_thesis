...
%Since an assignment to $\{A_1, \dots, A_{\numsensitive}\}$ uniquely denotes a compound sensitive group, say $ \mathbf{a}_{\mathsf{fav}} \in A $, we find the most favored group $ \mathbf{a}_{\mathsf{fav}} $ for which $ \Pr[\Phi_{\mathsf{ER}}] $ achieves the highest PPV. 
