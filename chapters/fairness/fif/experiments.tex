...
\begin{figure}[t!]
	\centering
		...
		\centering
		\subfloat{\includegraphics[scale=0.38]{figures/fairness/fif/runtime_diff_methods_train_sp}}\vspace*{-.7em}
...
%		\centering
%		\subfloat{\includegraphics[scale=0.35]{figures/fairness/fif/sp_compas_train_error.pdf}}
%		\subfloat{\includegraphics[scale=0.35]{figures/fairness/fif/sp_compas_train_time.pdf}}
%		
%		\caption{Effect of spline intervals on the estimation error of statistical parity and  execution time of {\fairXplainer} on COMPAS.}
%		\label{fairness_fairXplainer_fig:effect_spline_intervals}
	\end{minipage}
\end{figure}
...
\begin{figure}
	...
	\caption{Effects of a fairness attack~\cite{solans2020poisoning} and a fairness enhancing~\cite{kamiran2012data} algorithms on FIFs.}\label{fairness_fairXplainer_fig:affirmative_punitive_actions}
\end{figure}
