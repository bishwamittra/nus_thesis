...
\begin{itemize}
	...
	\begin{equation}
		...
		S_j^i:= \neg \bool_j^i; \qquad \mathsf{wt}(S_j^i)= \lambda
	\end{equation}
	...
	\begin{equation}
		...
		H_l:= \neg \eta_l \rightarrow \Big(y^{(l)}\leftrightarrow \bigwedge_{i=1}^k {\mathbf{x}^{(l)}} \circ {\boolset_{i}}\Big); \qquad  \mathsf{wt}(H_l)=\infty
	\end{equation}
